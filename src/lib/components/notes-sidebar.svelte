<script lang="ts">
	...
	import { formatShortcut, type FolderMetadata, type GithubUser, type KeyboardShortcuts, type PrimaryModifier, type VaultDescriptor, type VaultSearchResult } from '$lib';
